...
```yaml
subsystem_id: "95-20-57"
name: "NN_Wing_Systems"
description: "Wing system neural networks (LSTM, vision) for flutter prediction, ice detection, and load alleviation"
parent_ata: "ATA 57"
criticality: "DAL-A"
status: "active"
version: "1.0"
...
Wing system neural networks (LSTM, vision) for flutter prediction, ice detection, and load alleviation

## Key Capabilities

- Flutter Prediction: LSTM model (10 seconds ahead)
...
- `95-20-57-001_*_Overview.md` — Architecture and overview
- `95-20-57-002_*` through `95-20-57-00X_*` — Individual components
- `95-20-57-005_Integration_with_ATA 57.md` — Integration with parent ATA chapter

### ASSETS

- Diagrams: `ASSETS/95-20-57-A-001_*.drawio`, `ASSETS/95-20-57-A-002_*.svg`
- Configuration: `ASSETS/95-20-57-A-003_*.json`
- Model Cards: `ASSETS/Model_Cards/95-20-57-A-2XX_*.yaml`
...
- **Input Sensors**: See `95-20-57-005_Integration_with_ATA 57.md`
- **Control Outputs**: See `95-20-57-005_Integration_with_ATA 57.md`
...
- `95-20-57-A-2XX_ModelName_vX.Y.yaml`
...
- [ATA 57](../../..) — Parent ATA chapter documentation

## Document Control

- **Owner**: AMPEL360 NN_Wing_Systems Team
- **Version**: 1.0
- **Status**: Active
