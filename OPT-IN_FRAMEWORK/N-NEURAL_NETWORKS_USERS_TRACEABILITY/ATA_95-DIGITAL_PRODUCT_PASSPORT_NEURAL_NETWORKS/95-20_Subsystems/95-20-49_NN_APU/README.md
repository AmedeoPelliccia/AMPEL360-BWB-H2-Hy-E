...
```yaml
subsystem_id: "95-20-49"
name: "NN_APU"
description: "APU neural networks for performance prediction and health monitoring"
parent_ata: "ATA 49"
criticality: "DAL-D"
status: "active"
version: "1.0"
...
APU neural networks for performance prediction and health monitoring

## Key Capabilities

- APU Performance Prediction: Efficiency optimization
...
- `95-20-49-001_*_Overview.md` — Architecture and overview
- `95-20-49-002_*` through `95-20-49-00X_*` — Individual components
- `95-20-49-005_Integration_with_ATA 49.md` — Integration with parent ATA chapter

### ASSETS

- Diagrams: `ASSETS/95-20-49-A-001_*.drawio`, `ASSETS/95-20-49-A-002_*.svg`
- Configuration: `ASSETS/95-20-49-A-003_*.json`
- Model Cards: `ASSETS/Model_Cards/95-20-49-A-2XX_*.yaml`
...
- **Input Sensors**: See `95-20-49-005_Integration_with_ATA 49.md`
- **Control Outputs**: See `95-20-49-005_Integration_with_ATA 49.md`
...
- `95-20-49-A-2XX_ModelName_vX.Y.yaml`
...
- **[DO-178C](https://www.rtca.org/content/standards-guidance-materials)**: Software DAL-D
...
- [ATA 49](../../..) — Parent ATA chapter documentation

## Document Control

- **Owner**: AMPEL360 NN_APU Team
- **Version**: 1.0
- **Status**: Active
