...
See: `ASSETS/Model_Cards/95-20-21-A-102_Air_Quality_Monitor_v1.0.yaml`
...
- **Related Files**: 
  - Source: `Models/Source/air_quality_monitor_v1.0.py`
  - Trained: `Models/Trained/air_quality_monitor_v1.0.onnx`
  - Config: `Models/Configs/training_config_air_quality.yaml`
