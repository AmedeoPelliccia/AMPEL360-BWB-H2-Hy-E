...
```yaml
subsystem_id: "95-20-80"
name: "NN_Energy_Systems"
description: "Energy system neural networks for power load prediction, battery SOH estimation, and energy management optimization"
parent_ata: "ATA 80"
criticality: "DAL-B"
status: "active"
version: "1.0"
...
Energy system neural networks for power load prediction, battery SOH estimation, and energy management optimization

## Key Capabilities

- Power Load Prediction: 5 minutes ahead
...
- `95-20-80-001_*_Overview.md` — Architecture and overview
- `95-20-80-002_*` through `95-20-80-00X_*` — Individual components
- `95-20-80-005_Integration_with_ATA 80.md` — Integration with parent ATA chapter

### ASSETS

- Diagrams: `ASSETS/95-20-80-A-001_*.drawio`, `ASSETS/95-20-80-A-002_*.svg`
- Configuration: `ASSETS/95-20-80-A-003_*.json`
- Model Cards: `ASSETS/Model_Cards/95-20-80-A-2XX_*.yaml`
...
- **Input Sensors**: See `95-20-80-005_Integration_with_ATA 80.md`
- **Control Outputs**: See `95-20-80-005_Integration_with_ATA 80.md`
...
- `95-20-80-A-2XX_ModelName_vX.Y.yaml`
...
- [ATA 80](../../..) — Parent ATA chapter documentation

## Document Control

- **Owner**: AMPEL360 NN_Energy_Systems Team
- **Version**: 1.0
- **Status**: Active
