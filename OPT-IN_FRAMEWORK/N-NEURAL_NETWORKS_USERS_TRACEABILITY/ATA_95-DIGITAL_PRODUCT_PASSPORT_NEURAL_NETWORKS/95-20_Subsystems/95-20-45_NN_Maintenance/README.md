...
```yaml
subsystem_id: "95-20-45"
name: "NN_Maintenance"
description: "Maintenance neural networks for predictive maintenance, RUL estimation, and fault diagnosis"
parent_ata: "ATA 45"
criticality: "DAL-C"
status: "active"
version: "1.0"
...
Maintenance neural networks for predictive maintenance, RUL estimation, and fault diagnosis

## Key Capabilities

- Predictive Maintenance: 500 flight hours prediction horizon
...
- `95-20-45-001_*_Overview.md` — Architecture and overview
- `95-20-45-002_*` through `95-20-45-00X_*` — Individual components
- `95-20-45-005_Integration_with_ATA 45.md` — Integration with parent ATA chapter

### ASSETS

- Diagrams: `ASSETS/95-20-45-A-001_*.drawio`, `ASSETS/95-20-45-A-002_*.svg`
- Configuration: `ASSETS/95-20-45-A-003_*.json`
- Model Cards: `ASSETS/Model_Cards/95-20-45-A-2XX_*.yaml`
...
- **Input Sensors**: See `95-20-45-005_Integration_with_ATA 45.md`
- **Control Outputs**: See `95-20-45-005_Integration_with_ATA 45.md`
...
- `95-20-45-A-2XX_ModelName_vX.Y.yaml`
...
- [ATA 45](../../..) — Parent ATA chapter documentation

## Document Control

- **Owner**: AMPEL360 NN_Maintenance Team
- **Version**: 1.0
- **Status**: Active
