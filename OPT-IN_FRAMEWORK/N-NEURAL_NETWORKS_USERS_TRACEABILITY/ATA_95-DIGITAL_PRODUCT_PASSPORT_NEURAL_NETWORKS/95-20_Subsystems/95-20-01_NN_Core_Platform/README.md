...
name: "NN_Core_Platform"
description: "Core neural network infrastructure providing model registry, inference runtime, and monitoring framework for all NN subsystems"
parent_ata: "ATA 95"
criticality: "DAL-A"
status: "active"
version: "1.0"
...
Core neural network infrastructure providing model registry, inference runtime, and monitoring framework for all NN subsystems
...
- `95-20-01-001_*_Overview.md` — Architecture and overview
- `95-20-01-002_*` through `95-20-01-00X_*` — Individual components
- `95-20-01-005_Integration_with_ATA 95.md` — Integration with parent ATA chapter

### ASSETS

- Diagrams: `ASSETS/95-20-01-A-001_*.drawio`, `ASSETS/95-20-01-A-002_*.svg`
- Configuration: `ASSETS/95-20-01-A-003_*.json`
- Model Cards: `ASSETS/Model_Cards/95-20-01-A-2XX_*.yaml`
...
- **Input Sensors**: See `95-20-01-005_Integration_with_ATA 95.md`
- **Control Outputs**: See `95-20-01-005_Integration_with_ATA 95.md`
...
- `95-20-01-A-2XX_ModelName_vX.Y.yaml`
...
- **Owner**: AMPEL360 NN_Core_Platform Team
- **Version**: 1.0
- **Status**: Active
