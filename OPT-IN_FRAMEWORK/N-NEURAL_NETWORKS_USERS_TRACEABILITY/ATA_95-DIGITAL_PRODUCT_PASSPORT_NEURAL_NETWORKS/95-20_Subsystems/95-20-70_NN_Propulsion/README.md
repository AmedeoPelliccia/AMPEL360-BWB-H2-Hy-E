...
```yaml
subsystem_id: "95-20-70"
name: "NN_Propulsion"
description: "Propulsion neural networks for engine performance modeling, fuel cell optimization, and thrust prediction"
parent_ata: "ATA 70-79"
criticality: "DAL-A"
status: "active"
version: "1.0"
...
Propulsion neural networks for engine performance modeling, fuel cell optimization, and thrust prediction

## Key Capabilities

- Engine Performance Modeling: Digital twin
...
- `95-20-70-001_*_Overview.md` — Architecture and overview
- `95-20-70-002_*` through `95-20-70-00X_*` — Individual components
- `95-20-70-005_Integration_with_ATA 70-79.md` — Integration with parent ATA chapter

### ASSETS

- Diagrams: `ASSETS/95-20-70-A-001_*.drawio`, `ASSETS/95-20-70-A-002_*.svg`
- Configuration: `ASSETS/95-20-70-A-003_*.json`
- Model Cards: `ASSETS/Model_Cards/95-20-70-A-2XX_*.yaml`
...
**Parent ATA**: ATA 70-79

- **Input Sensors**: See `95-20-70-005_Integration_with_ATA 70-79.md`
- **Control Outputs**: See `95-20-70-005_Integration_with_ATA 70-79.md`
...
- `95-20-70-A-2XX_ModelName_vX.Y.yaml`
...
- **[DO-178C](https://www.rtca.org/content/standards-guidance-materials)**: Software DAL-A
...
- [ATA 70-79](../../..) — Parent ATA chapter documentation

## Document Control

- **Owner**: AMPEL360 NN_Propulsion Team
- **Version**: 1.0
- **Status**: Active
