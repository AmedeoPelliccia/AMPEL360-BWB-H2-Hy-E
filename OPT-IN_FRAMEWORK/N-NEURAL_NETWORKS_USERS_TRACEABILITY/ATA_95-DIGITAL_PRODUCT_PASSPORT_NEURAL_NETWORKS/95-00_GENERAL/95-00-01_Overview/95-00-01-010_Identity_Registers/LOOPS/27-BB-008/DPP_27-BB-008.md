---
document_id: DPP_27-BB-008
title: Digital Product Passport for 27-BB-008
...
# DPP_27-BB-008 — Digital Product Passport

## 1. Purpose

This document is the **Digital Product Passport (DPP)** for `27-BB-008` — `Active Gust Alleviation System`.
...
**DPP Governance**: ATA 95 (Brain) / `27` (Body, if applicable)
...
### 3.2 ATA Sovereignty
- **Body Sovereignty**: ATA `27` (functional/physical ownership)
...
```json
{
  ...
  "bb_id": "27-BB-008",
  "artifact_name": "Active Gust Alleviation System",
  "version": "1.0",
  "issuance_date": "<date>",
  "status": "<status>",
  "identity": {
