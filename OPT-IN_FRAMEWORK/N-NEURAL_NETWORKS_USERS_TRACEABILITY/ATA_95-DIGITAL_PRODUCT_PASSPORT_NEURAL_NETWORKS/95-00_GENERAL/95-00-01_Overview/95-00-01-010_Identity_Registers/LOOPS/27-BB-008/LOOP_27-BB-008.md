---
document_id: LOOP_27-BB-008
title: Loop Control Record for 27-BB-008
...
# LOOP_27-BB-008 — Circuit Control Record
...
| **Body ATA** | `27` (functional/physical ownership) |
...
- **OM Class**: `Flight Control Augmentation - Gust Load Alleviation` (operational manifestation type)
- **Version**: `1.0`
- **Last Updated**: `<date>`
...
**End of LOOP_27-BB-008 Control Record**
