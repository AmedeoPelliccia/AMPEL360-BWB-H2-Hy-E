---
document_id: LOOP_73-BB-001
title: Loop Control Record for 73-BB-001
...
# LOOP_73-BB-001 — Circuit Control Record
...
|---|---|
| **BB ID** | `73-BB-001` |
| **Artifact Name** | `Full Authority Digital Engine Control (FADEC)` |
| **Body ATA** | `73` (functional/physical ownership) |
| **Brain ATA** | `73` (executing logic ownership) |
...
- **OM Class**: `Engine Control - Thrust Management and Protection` (operational manifestation type)
- **Version**: `1.0`
- **Last Updated**: `<date>`
...
**End of LOOP_73-BB-001 Control Record**
