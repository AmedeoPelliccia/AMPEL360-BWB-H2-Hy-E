---
document_id: AM_73-BB-001
title: At-Rest Model for 73-BB-001
...
# AM_73-BB-001 — At-Rest Model (Baseline Definition)

## 1. Purpose

This document defines the **At-Rest Model (AM)** for `73-BB-001` — `Full Authority Digital Engine Control (FADEC)`.
