---
document_id: OM_73-BB-001
title: Operational Mission for 73-BB-001
...
# OM_73-BB-001 — Operational Mission

## 1. Purpose

This document defines the **Operational Mission (OM)** for `73-BB-001` — `Full Authority Digital Engine Control (FADEC)`.
