---
document_id: AM_28-BB-007
title: At-Rest Model for 28-BB-007
...
# AM_28-BB-007 — At-Rest Model (Baseline Definition)

## 1. Purpose

This document defines the **At-Rest Model (AM)** for `28-BB-007` — `LH₂ Tank System`.
