---
document_id: AM_95-BB-001
title: At-Rest Model for 95-BB-001
...
# AM_95-BB-001 — At-Rest Model (Baseline Definition)

## 1. Purpose

This document defines the **At-Rest Model (AM)** for `95-BB-001` — `AI Inference Engine`.
