---
document_id: LOOP_95-BB-001
title: Loop Control Record for 95-BB-001
...
# LOOP_95-BB-001 — Circuit Control Record
...
|---|---|
| **BB ID** | `95-BB-001` |
| **Artifact Name** | `AI Inference Engine` |
| **Body ATA** | `95` (functional/physical ownership) |
| **Brain ATA** | `95` (executing logic ownership) |
| **DAL** | `variable by integration` (infrastructure declares capability tiers) |
| **Brain Type** | `ML-INF` (e.g., ML-INF, RT-CTRL, NAV, HMI, DATA, etc.) |
| **DPP Governance** | ATA 95 (Digital Product Passport authority) |
| **Note** | The AI Inference Engine DAL varies based on the models it hosts and their integration context |
...
- **OM Class**: `AI Infrastructure - Model Inference and Governance` (operational manifestation type)
- **Version**: `1.0`
- **Last Updated**: `<date>`
...
**End of LOOP_95-BB-001 Control Record**
