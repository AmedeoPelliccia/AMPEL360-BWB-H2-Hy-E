---
document_id: DPP_95-BB-001
title: Digital Product Passport for 95-BB-001
...
# DPP_95-BB-001 — Digital Product Passport

## 1. Purpose

This document is the **Digital Product Passport (DPP)** for `95-BB-001` — `AI Inference Engine`.
...
**DPP Governance**: ATA 95 (Brain) / `95` (Body, if applicable)
...
### 3.2 ATA Sovereignty
- **Body Sovereignty**: ATA `95` (functional/physical ownership)
- **Brain Sovereignty**: ATA `95` (executing logic ownership)
...
- **OM Class**: `AI Infrastructure - Model Inference and Governance`
- **OM Reference**: `<om_ref>`
...
```json
{
  "dpp_id": "DPP-95-BB-001-v1.0",
  "bb_id": "95-BB-001",
  "artifact_name": "AI Inference Engine",
  "version": "1.0",
  "issuance_date": "<date>",
  "status": "<status>",
  "identity": {
