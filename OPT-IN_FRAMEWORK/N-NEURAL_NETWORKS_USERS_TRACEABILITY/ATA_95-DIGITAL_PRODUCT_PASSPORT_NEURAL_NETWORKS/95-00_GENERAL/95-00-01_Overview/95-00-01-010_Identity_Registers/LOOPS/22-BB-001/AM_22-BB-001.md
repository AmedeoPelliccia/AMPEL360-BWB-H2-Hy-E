---
document_id: AM_22-BB-001
title: At-Rest Model for 22-BB-001
...
# AM_22-BB-001 — At-Rest Model (Baseline Definition)

## 1. Purpose

This document defines the **At-Rest Model (AM)** for `22-BB-001` — `Flight Management Computer (FMC)`.
