---
document_id: LOOP_22-BB-001
title: Loop Control Record for 22-BB-001
...
# LOOP_22-BB-001 — Circuit Control Record
...
|---|---|
| **BB ID** | `22-BB-001` |
| **Artifact Name** | `Flight Management Computer (FMC)` |
| **Body ATA** | `22` (functional/physical ownership) |
| **Brain ATA** | `22` (executing logic ownership) |
| **DAL** | `B` (Design Assurance Level) |
| **Brain Type** | `NAV` (e.g., ML-INF, RT-CTRL, NAV, HMI, DATA, etc.) |
...
- **OM Class**: `Auto Flight - Flight Management and Navigation` (operational manifestation type)
- **Version**: `1.0`
- **Last Updated**: `<date>`
...
**End of LOOP_22-BB-001 Control Record**
