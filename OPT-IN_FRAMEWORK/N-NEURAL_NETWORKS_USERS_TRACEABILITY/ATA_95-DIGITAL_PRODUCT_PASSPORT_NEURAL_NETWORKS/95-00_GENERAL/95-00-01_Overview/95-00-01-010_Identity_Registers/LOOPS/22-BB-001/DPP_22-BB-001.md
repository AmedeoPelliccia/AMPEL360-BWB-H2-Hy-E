---
document_id: DPP_22-BB-001
title: Digital Product Passport for 22-BB-001
...
# DPP_22-BB-001 — Digital Product Passport

## 1. Purpose

This document is the **Digital Product Passport (DPP)** for `22-BB-001` — `Flight Management Computer (FMC)`.
...
**DPP Governance**: ATA 95 (Brain) / `22` (Body, if applicable)
...
### 3.2 ATA Sovereignty
- **Body Sovereignty**: ATA `22` (functional/physical ownership)
- **Brain Sovereignty**: ATA `22` (executing logic ownership)
...
- **OM Class**: `Auto Flight - Flight Management and Navigation`
- **OM Reference**: `<om_ref>`
...
```json
{
  "dpp_id": "DPP-22-BB-001-v1.0",
  "bb_id": "22-BB-001",
  "artifact_name": "Flight Management Computer (FMC)",
  "version": "1.0",
  "issuance_date": "<date>",
  "status": "<status>",
  "identity": {
