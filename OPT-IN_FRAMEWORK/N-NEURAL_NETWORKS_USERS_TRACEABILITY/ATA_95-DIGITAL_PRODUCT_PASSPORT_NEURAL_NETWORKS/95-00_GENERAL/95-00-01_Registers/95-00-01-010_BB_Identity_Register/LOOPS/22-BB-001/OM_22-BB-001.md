---
document_id: OM_22-BB-001
title: Operational Mission for 22-BB-001
...
# OM_22-BB-001 — Operational Mission

## 1. Purpose

This document defines the **Operational Mission (OM)** for `22-BB-001` — `Flight Management Computer (FMC)`.
