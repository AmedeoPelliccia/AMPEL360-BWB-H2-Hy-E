---
document_id: AM_80-BB-004
title: At-Rest Model for 80-BB-004
...
# AM_80-BB-004 — At-Rest Model (Baseline Definition)

## 1. Purpose

This document defines the **At-Rest Model (AM)** for `80-BB-004` — `Main Fuel Cell System`.
