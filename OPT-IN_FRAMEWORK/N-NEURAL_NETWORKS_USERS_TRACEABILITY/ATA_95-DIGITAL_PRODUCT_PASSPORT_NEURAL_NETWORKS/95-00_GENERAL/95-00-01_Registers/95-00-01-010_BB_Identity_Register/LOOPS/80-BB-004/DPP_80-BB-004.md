---
document_id: DPP_80-BB-004
title: Digital Product Passport for 80-BB-004
...
# DPP_80-BB-004 — Digital Product Passport

## 1. Purpose

This document is the **Digital Product Passport (DPP)** for `80-BB-004` — `Main Fuel Cell System`.
...
**DPP Governance**: ATA 95 (Brain) / `80` (Body, if applicable)
...
### 3.2 ATA Sovereignty
- **Body Sovereignty**: ATA `80` (functional/physical ownership)
- **Brain Sovereignty**: ATA `80` (executing logic ownership)
...
```json
{
  "dpp_id": "DPP-80-BB-004-v1.0",
  "bb_id": "80-BB-004",
  "artifact_name": "Main Fuel Cell System",
  "version": "1.0",
  "issuance_date": "<date>",
  "status": "<status>",
  "identity": {
