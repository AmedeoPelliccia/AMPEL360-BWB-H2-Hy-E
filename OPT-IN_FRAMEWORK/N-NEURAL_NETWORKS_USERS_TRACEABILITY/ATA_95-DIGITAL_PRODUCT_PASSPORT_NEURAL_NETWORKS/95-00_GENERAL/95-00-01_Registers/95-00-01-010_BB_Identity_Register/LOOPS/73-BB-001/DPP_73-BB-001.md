---
document_id: DPP_73-BB-001
title: Digital Product Passport for 73-BB-001
...
# DPP_73-BB-001 — Digital Product Passport

## 1. Purpose

This document is the **Digital Product Passport (DPP)** for `73-BB-001` — `Full Authority Digital Engine Control (FADEC)`.
...
**DPP Governance**: ATA 95 (Brain) / `73` (Body, if applicable)
...
### 3.2 ATA Sovereignty
- **Body Sovereignty**: ATA `73` (functional/physical ownership)
- **Brain Sovereignty**: ATA `73` (executing logic ownership)
...
- **OM Class**: `Engine Control - Thrust Management and Protection`
- **OM Reference**: `<om_ref>`
...
```json
{
  "dpp_id": "DPP-73-BB-001-v1.0",
  "bb_id": "73-BB-001",
  "artifact_name": "Full Authority Digital Engine Control (FADEC)",
  "version": "1.0",
  "issuance_date": "<date>",
  "status": "<status>",
  "identity": {
