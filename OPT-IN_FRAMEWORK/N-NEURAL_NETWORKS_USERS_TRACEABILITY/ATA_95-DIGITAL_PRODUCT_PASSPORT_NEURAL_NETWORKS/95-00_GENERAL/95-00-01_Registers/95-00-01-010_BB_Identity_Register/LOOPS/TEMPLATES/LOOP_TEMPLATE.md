---
document_id: LOOP_<bb_id>
title: Loop Control Record for <bb_id>
...
# LOOP_<bb_id> — Circuit Control Record
...
| **Brain Type** | `<BrainType>` (e.g., ML-INF, RT-CTRL, NAV, HMI, DATA, etc.) |
...
- **OM Class**: `<om_class>` (operational manifestation type)
- **Version**: `<version>`
- **Last Updated**: `<date>`
...
**End of LOOP_<bb_id> Control Record**
