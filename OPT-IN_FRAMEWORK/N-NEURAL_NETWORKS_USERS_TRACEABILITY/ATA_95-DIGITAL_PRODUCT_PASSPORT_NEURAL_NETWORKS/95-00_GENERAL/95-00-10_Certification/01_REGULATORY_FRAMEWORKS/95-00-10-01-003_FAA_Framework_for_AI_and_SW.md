...
- **Assurance Activities**: Aligned with DO-178C but extended for ML
...
1. **AC 20-152**: RTCA DO-178C (Software)
2. **AC 20-115D**: RTCA DO-254 (Hardware)
...
### FAA Acceptance
- DO-178C fully accepted by FAA via AC 20-152
- Tool qualification per DO-330
- Model-based development per DO-331
- Formal methods per DO-333
