# 95-00-10-09-005 Corrective Actions and Preventive Actions (CAPA)

## Document Information
- **Document ID**: 95-00-10-09-005
- **Title**: Corrective Actions and Preventive Actions (CAPA)
- **Version**: 1.0
- **Status**: Draft
...
This document defines the CAPA process for addressing audit findings and preventing recurrence.

## Content

This document provides detailed information about Corrective Actions and Preventive Actions (CAPA) for the AMPEL360 BWB H₂ Hy-E Q100 aircraft certification program.
