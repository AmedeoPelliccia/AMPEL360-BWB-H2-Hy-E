# 95-00-10-06-001 Software Certification Strategy (DO-178C Family)

## Document Information
- **Document ID**: 95-00-10-06-001
- **Title**: Software Certification Strategy (DO-178C Family)
- **Version**: 1.0
- **Status**: Draft
...
This document defines the software certification strategy based on [DO-178C](https://www.rtca.org/content/standards-guidance-materials) and supplements (DO-330, DO-331, DO-333).

## Content

This document provides detailed information about Software Certification Strategy (DO-178C Family) for the AMPEL360 BWB H₂ Hy-E Q100 aircraft certification program.
