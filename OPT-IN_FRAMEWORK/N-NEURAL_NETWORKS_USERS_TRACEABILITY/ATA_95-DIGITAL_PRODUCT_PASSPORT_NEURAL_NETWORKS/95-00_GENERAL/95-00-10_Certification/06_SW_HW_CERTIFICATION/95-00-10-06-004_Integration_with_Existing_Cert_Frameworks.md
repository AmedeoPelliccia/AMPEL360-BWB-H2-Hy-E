# 95-00-10-06-004 Integration with Existing Certification Frameworks

## Document Information
- **Document ID**: 95-00-10-06-004
- **Title**: Integration with Existing Certification Frameworks
- **Version**: 1.0
- **Status**: Draft
...
This document describes how SW/HW certification integrates with existing [DO-178C](https://www.rtca.org/content/standards-guidance-materials)/[DO-254](https://www.rtca.org/content/standards-guidance-materials) frameworks and AMPEL360-specific extensions.

## Content

This document provides detailed information about Integration with Existing Certification Frameworks for the AMPEL360 BWB H₂ Hy-E Q100 aircraft certification program.
...
- Integration with broader certification strategy
