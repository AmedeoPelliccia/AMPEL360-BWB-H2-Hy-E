# 95-00-10-06-002 Hardware Certification Strategy (DO-254 Family)

## Document Information
- **Document ID**: 95-00-10-06-002
- **Title**: Hardware Certification Strategy (DO-254 Family)
- **Version**: 1.0
- **Status**: Draft
...
This document defines the hardware certification strategy based on [DO-254](https://www.rtca.org/content/standards-guidance-materials) for custom electronic hardware components.

## Content

This document provides detailed information about Hardware Certification Strategy (DO-254 Family) for the AMPEL360 BWB H₂ Hy-E Q100 aircraft certification program.
