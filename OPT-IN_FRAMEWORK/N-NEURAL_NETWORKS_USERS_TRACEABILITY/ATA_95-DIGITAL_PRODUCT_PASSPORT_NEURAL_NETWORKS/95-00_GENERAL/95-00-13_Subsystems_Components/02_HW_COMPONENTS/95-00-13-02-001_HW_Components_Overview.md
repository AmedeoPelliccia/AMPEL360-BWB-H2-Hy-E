...
- **Document ID**: [95-00-13-02-001](95-00-13-02-001.md)
- **Title**: HW Components Overview
- **Version**: 1.0
- **Status**: Active
...
This document provides a comprehensive overview of hardware components used in the AMPEL360 BWB H₂ Hy-E aircraft system.

## Hardware Component Categories

### 1. Compute Boards and Modules
...
- Ethernet switches
- CAN bus controllers
- [ARINC 429](https://www.aviation-ia.com/cf/aeec.html) interfaces
...
See: [ASSETS/[95-00-13-02-A-001_HW_Components_List](95-00-13-02-A-001_HW_Components_List.md).xlsx](ASSETS/95-00-13-02-A-001_HW_Components_List.xlsx)
