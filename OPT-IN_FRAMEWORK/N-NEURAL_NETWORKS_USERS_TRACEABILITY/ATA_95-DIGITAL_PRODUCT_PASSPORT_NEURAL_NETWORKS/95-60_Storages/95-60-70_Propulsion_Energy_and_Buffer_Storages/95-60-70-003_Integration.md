# 95-60-70-003 Propulsion Energy and Buffer Storages Integration and Interfaces

**Document ID:** 95-60-70-003  
**Version:** 1.0  
**Date:** 2025-11-17  
**Status:** ACTIVE
...
This document defines integration architecture, sensor systems, and interfaces for propulsion-side energy buffers and thermal storage within the AMPEL360 aircraft.
...
**Mounting**: Structural mounting details in 95-50-70 Structures

**Access**: Maintenance access requirements

### 2.2 Functional Integration

**Primary Systems**: ATA 70 - Propulsion (Standard Practices)

**Supporting Systems**: ATA 28, 21
...
- **[95-60-70-004](95-60-70-004_Health_Monitoring.md)**: Health monitoring
