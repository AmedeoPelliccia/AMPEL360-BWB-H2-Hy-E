# 95-60-49-003 APU and Auxiliary Storages Integration and Interfaces

**Document ID:** 95-60-49-003  
**Version:** 1.0  
**Date:** 2025-11-17  
**Status:** ACTIVE
...
This document defines integration architecture, sensor systems, and interfaces for APU fuel and oil storage systems within the AMPEL360 aircraft.
...
**Mounting**: Structural mounting details in 95-50-49 Structures

**Access**: Maintenance access requirements

### 2.2 Functional Integration

**Primary Systems**: ATA 49 - Airborne Auxiliary Power
...
- **[95-60-49-004](95-60-49-004_Health_Monitoring.md)**: Health monitoring
