# 95-60-28-003 H₂ Storages Integration and Interfaces

**Document ID:** 95-60-28-003  
**Version:** 1.0  
**Date:** 2025-11-17  
**Status:** ACTIVE
...
This document defines integration architecture, sensor systems, and interfaces for liquid hydrogen storage tanks and buffer systems within the AMPEL360 aircraft.
...
**Mounting**: Structural mounting details in 95-50-28 Structures

**Access**: Maintenance access requirements

### 2.2 Functional Integration

**Primary Systems**: ATA 28 - Fuel (Hydrogen)

**Supporting Systems**: ATA 70, 80
...
- **[95-60-28-004](95-60-28-004_Health_Monitoring.md)**: Health monitoring
