# 10-00-03-040-K_Climate_Zone_Matrix — Climate Zone Matrix

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-040-K_Climate_Zone_Matrix |
| **Title** | Climate Zone Matrix |
...
This document defines requirements for climate zone matrix in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
