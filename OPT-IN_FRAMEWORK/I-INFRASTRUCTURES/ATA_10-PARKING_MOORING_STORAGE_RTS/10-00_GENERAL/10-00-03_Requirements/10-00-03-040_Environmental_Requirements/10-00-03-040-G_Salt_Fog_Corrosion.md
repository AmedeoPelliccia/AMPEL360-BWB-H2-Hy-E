# 10-00-03-040-G_Salt_Fog_Corrosion — Salt Fog Corrosion

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-040-G_Salt_Fog_Corrosion |
| **Title** | Salt Fog Corrosion |
...
This document defines requirements for salt fog corrosion in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
