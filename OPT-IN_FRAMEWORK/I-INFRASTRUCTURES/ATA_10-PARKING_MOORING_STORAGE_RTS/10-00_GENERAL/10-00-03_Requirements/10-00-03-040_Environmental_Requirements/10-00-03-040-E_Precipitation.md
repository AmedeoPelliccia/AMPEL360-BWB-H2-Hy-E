# 10-00-03-040-E_Precipitation — Precipitation

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-040-E_Precipitation |
| **Title** | Precipitation |
...
This document defines requirements for precipitation in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
