# 10-00-03-020-C2_Mooring_Loads — Mooring Loads

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-020-C2_Mooring_Loads |
| **Title** | Mooring Loads |
...
This document defines requirements for mooring loads in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
