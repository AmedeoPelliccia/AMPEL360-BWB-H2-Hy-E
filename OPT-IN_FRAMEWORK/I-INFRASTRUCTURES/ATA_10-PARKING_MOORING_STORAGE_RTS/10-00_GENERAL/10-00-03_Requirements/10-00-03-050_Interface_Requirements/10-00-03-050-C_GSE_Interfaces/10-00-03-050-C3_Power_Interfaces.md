# 10-00-03-050-C3_Power_Interfaces — Power Interfaces

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-050-C3_Power_Interfaces |
| **Title** | Power Interfaces |
...
This document defines requirements for power interfaces in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
