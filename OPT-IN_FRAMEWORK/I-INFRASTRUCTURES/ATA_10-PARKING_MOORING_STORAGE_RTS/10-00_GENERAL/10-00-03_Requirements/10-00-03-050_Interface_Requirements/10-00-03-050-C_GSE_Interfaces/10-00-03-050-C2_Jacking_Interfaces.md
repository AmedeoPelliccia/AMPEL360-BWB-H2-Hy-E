# 10-00-03-050-C2_Jacking_Interfaces — Jacking Interfaces

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-050-C2_Jacking_Interfaces |
| **Title** | Jacking Interfaces |
...
This document defines requirements for jacking interfaces in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
