# 10-00-03-050-D2_Hangar_Interfaces — Hangar Interfaces

## Document Information

| Attribute | Value |
|-----------|-------|
| **Document ID** | 10-00-03-050-D2_Hangar_Interfaces |
| **Title** | Hangar Interfaces |
...
This document defines requirements for hangar interfaces in the context of ATA Chapter 10 — Parking, Mooring, Storage, and Return-to-Service (RTS) operations for the AMPEL360 Q100 aircraft.
