...
| Field | Value |
|-------|-------|
| Document Number | 10-20-02A |
| Title | Tiedown Points Design |
| Revision | A |
| Date | 2025-12-11 |
| Status | DRAFT |
| Subsystem Type | tiedown |
| Subsystem ID | TIEDOWN-POINTS-001 |

## 2. Purpose and Scope

### 2.1 Purpose
Detailed design specification for tiedown attachment points on the AMPEL360-BWB-H2 aircraft structure.

### 2.2 Scope
This document provides detailed specifications for the Tiedown Points Design as part of the AMPEL360-BWB-H2 parking, mooring, and storage systems.
...
|--------|-------------|----------|---------------------|
| FR-10-20-02A-001 | [Functional requirement 1] | High | Test |
| FR-10-20-02A-002 | [Functional requirement 2] | Medium | Analysis |

### 4.2 Performance Requirements

| Req ID | Parameter | Value | Unit | Verification |
|--------|-----------|-------|------|--------------|
| PR-10-20-02A-001 | [Parameter] | [Value] | [Unit] | Test |

### 4.3 Safety Requirements

| Req ID | Requirement | DAL | Verification Method |
|--------|-------------|-----|---------------------|
| SR-10-20-02A-001 | [Safety requirement] | [DAL] | Test + Analysis |
