# 10-20-13A - Storm Mooring System

## 1. Document Information

| Field | Value |
|-------|-------|
| Document Number | 10-20-13A |
| Title | Storm Mooring System |
| Revision | A |
| Date | 2025-12-11 |
| Status | DRAFT |
| Subsystem Type | mooring |
| Subsystem ID | MOORING-STORM-001 |

## 2. Purpose and Scope

### 2.1 Purpose
Enhanced mooring system for severe weather conditions (winds >70 kt).

### 2.2 Scope
This document provides detailed specifications for the Storm Mooring System as part of the AMPEL360-BWB-H2 parking, mooring, and storage systems.
...
|--------|-------------|----------|---------------------|
| FR-10-20-13A-001 | [Functional requirement 1] | High | Test |
| FR-10-20-13A-002 | [Functional requirement 2] | Medium | Analysis |

### 4.2 Performance Requirements

| Req ID | Parameter | Value | Unit | Verification |
|--------|-----------|-------|------|--------------|
| PR-10-20-13A-001 | [Parameter] | [Value] | [Unit] | Test |

### 4.3 Safety Requirements

| Req ID | Requirement | DAL | Verification Method |
|--------|-------------|-----|---------------------|
| SR-10-20-13A-001 | [Safety requirement] | [DAL] | Test + Analysis |
