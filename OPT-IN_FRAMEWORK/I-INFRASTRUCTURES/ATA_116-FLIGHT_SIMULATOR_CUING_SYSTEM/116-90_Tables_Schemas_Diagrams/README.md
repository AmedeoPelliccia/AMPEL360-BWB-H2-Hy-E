# 116-90_Tables_Schemas_Diagrams
...
This is a **cross-ATA root bucket** present in every ATA chapter. It provides a consistent location for tables, data dicts, catalogs, sds/training.
...
**Note**: If this bucket is not applicable to ATA 116, document the reason here. Do not remove the bucket.
