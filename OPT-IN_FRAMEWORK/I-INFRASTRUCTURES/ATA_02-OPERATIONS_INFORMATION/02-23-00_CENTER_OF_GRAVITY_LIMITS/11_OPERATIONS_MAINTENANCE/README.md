# 11_OPERATIONS_MAINTENANCE - Center of Gravity Limits

**Component Code:** 02-23-00  
**Component Name:** CENTER_OF_GRAVITY_LIMITS  
**Folder:** 11_OPERATIONS_MAINTENANCE

## Purpose

This folder contains comprehensive operations and maintenance documentation for center of gravity limits on the AMPEL360 BWB H2 Hy-E aircraft. It includes S1000D data modules, operational procedures, CAOS integration artifacts, and training materials.
...
│   ├── 02-23-00-01-00_FORWARD_CG_LIMIT/
│   ├── 02-23-00-02-00_AFT_CG_LIMIT/
│   ├── 02-23-00-03-00_CG_ENVELOPE/
│
├── Training_Materials/
...
- **Format**: AMP-02-23-00-XX-XX-XXX-A.XML
