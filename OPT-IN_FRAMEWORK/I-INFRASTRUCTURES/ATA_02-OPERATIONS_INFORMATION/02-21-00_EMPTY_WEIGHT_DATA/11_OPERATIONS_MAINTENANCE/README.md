# 11_OPERATIONS_MAINTENANCE - Empty Weight Data

**Component Code:** 02-21-00  
**Component Name:** EMPTY_WEIGHT_DATA  
**Folder:** 11_OPERATIONS_MAINTENANCE

## Purpose

This folder contains comprehensive operations and maintenance documentation for empty weight data on the AMPEL360 BWB H2 Hy-E aircraft. It includes S1000D data modules, operational procedures, CAOS integration artifacts, and training materials.
...
│   ├── 02-21-00-01-00_BASIC_EMPTY_WEIGHT/
│   ├── 02-21-00-02-00_OPERATING_EMPTY_WEIGHT/
│
├── Training_Materials/
...
**Total Procedures**: 10 complete procedure documents


## DMC Naming Convention

All Data Module Codes follow S1000D standard:
- **Format**: AMP-02-21-00-XX-XX-XXX-A.XML
