...
Describes how live power consumption is tracked at system and aircraft level with real-time telemetry and alerting.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for live power consumption tracking within the AMPEL360 BWB-H2-Hy-E energy operations framework.
