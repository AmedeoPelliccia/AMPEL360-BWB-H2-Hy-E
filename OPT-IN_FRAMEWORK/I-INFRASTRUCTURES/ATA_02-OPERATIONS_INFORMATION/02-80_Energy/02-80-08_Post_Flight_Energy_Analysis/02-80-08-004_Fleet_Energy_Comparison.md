# Fleet Energy Comparison

## Purpose

Documents comparison methods across aircraft, fleets, and time periods for energy metrics and best practice identification.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for fleet energy comparison within the AMPEL360 BWB-H2-Hy-E energy operations framework.
