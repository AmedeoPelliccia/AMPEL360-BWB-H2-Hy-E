...
Describes how battery state (SOC, SOH, temperature, limits) is monitored and exposed to operators for the AMPEL360 BWB-H2-Hy-E aircraft, ensuring safe operation and optimal performance.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for battery state monitoring within the AMPEL360 BWB-H2-Hy-E energy operations framework.
