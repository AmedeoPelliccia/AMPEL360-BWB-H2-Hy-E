...
Describes the data interface between battery management and thermal management systems, ensuring batteries operate within safe temperature ranges.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for thermal management interface within the AMPEL360 BWB-H2-Hy-E energy operations framework.
