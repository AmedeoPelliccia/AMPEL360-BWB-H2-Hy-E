...
Explains strategies for exploiting time-of-use tariffs and dynamic pricing to minimize energy costs.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for time-of-use optimization within the AMPEL360 BWB-H2-Hy-E energy operations framework.
