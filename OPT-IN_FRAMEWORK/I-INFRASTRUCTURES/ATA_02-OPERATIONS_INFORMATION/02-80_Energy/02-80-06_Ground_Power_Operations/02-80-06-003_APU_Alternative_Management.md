# APU Alternative Management

## Purpose

Explains how GPUs and other means are used to reduce APU usage while maintaining safety and operational availability.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for apu alternative management within the AMPEL360 BWB-H2-Hy-E energy operations framework.
