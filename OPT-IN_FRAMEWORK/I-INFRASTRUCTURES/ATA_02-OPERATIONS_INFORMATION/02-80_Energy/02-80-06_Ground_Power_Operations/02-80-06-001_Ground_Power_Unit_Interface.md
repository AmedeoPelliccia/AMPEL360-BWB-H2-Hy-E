# Ground Power Unit Interface

## Purpose

Defines data and control interfaces between aircraft and ground power units including connection protocols and safety checks.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for ground power unit interface within the AMPEL360 BWB-H2-Hy-E energy operations framework.
