# 02-80-01-003 Battery Status Integration

## Purpose

Explains how battery status (SOC, SOH, temperature, limits) is integrated into overall power monitoring views, providing unified visibility for flight crew and OCC.
