# 02-80-01-002 Generator Performance Data

## Purpose

Defines data captured from generators (engine-driven, APU, fuel-cell derived, GPU) for performance and health monitoring, including output metrics, efficiency tracking, and fault detection.
