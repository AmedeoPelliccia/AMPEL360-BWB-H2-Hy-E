# Power Electronics Health

## Purpose

Documents health metrics and fault modes for inverters, converters and related power electronics.

## Scope

This document covers operational procedures, data requirements, interface specifications, and integration points for power electronics health within the AMPEL360 BWB-H2-Hy-E energy operations framework.
