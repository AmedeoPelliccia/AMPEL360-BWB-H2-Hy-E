---
Title: "FMEA View: Training Phase — ATA 02"
...
Scope: "FMEA view definition for Training Phase related to ATA 02 Operations Information"
Abstract: "Defines the FMEA view for the Training Phase, describing how to filter and interpret the subset of FMEA entries that concern training activities from the canonical CSV source."
Keywords: ["ATA 02", "FMEA", "Training", "Human Factors", "Safety", "Operations Information"]
Compliance:
  - "ATA iSpec 2200"
  - "S1000D"
...
Links:
  ParentFMEA: "./02-00-02-004A_Failure_Modes_Effects_Analysis.csv"
  HazardMethodology: "./02-00-02-007A_Hazard_Analysis_Methodology.md"
  HumanFactors: "./02-00-02-008A_Human_Factors_Safety.md"
  ERP: "./02-00-02-003A_Emergency_Response_Procedures.md"
  OperationalSafety: "./02-00-02-009A_Operational_Safety_Procedures.md"
  RuntimeMonitoring: "./02-00-02-010A_Runtime_Safety_Monitoring.md"
  NNInterplay: "./02-00-02-011A_Safety_Cases_NN_Systems.md"
  Requirements: "../02-00-03_Requirements/"
  VAndV: "../02-00-07_V_AND_V/"
  ValidationTests: "./02-00-02-014A_Safety_Validation_Tests.csv"
  TrainingMaterials: "../../02-90_Tables_Schemas_Diagrams/"
ChangeLog:
  - {version: "1.0.0", date: "2025-11-14", author: "AMPEL360 Safety Team", change: "Initial creation"}
---
