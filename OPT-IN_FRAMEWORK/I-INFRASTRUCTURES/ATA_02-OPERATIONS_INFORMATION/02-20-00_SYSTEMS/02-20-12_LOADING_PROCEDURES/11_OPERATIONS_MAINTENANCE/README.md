# 11_OPERATIONS_MAINTENANCE - Loading Procedures

**Component Code:** 02-22-00  
**Component Name:** LOADING_PROCEDURES  
**Folder:** 11_OPERATIONS_MAINTENANCE

## Purpose

This folder contains comprehensive operations and maintenance documentation for loading procedures on the AMPEL360 BWB H2 Hy-E aircraft. It includes S1000D data modules, operational procedures, CAOS integration artifacts, and training materials.
...
│   ├── 02-22-00-01-00_PASSENGER_LOADING/
│   ├── 02-22-00-02-00_CARGO_LOADING/
│   ├── 02-22-00-03-00_H2_FUEL_LOADING_SEQUENCE/
│   ├── 02-22-00-04-00_WEIGHT_BALANCE_CALCULATION/
│
├── Training_Materials/
...
**Total Procedures**: 23 complete procedure documents


## DMC Naming Convention

All Data Module Codes follow S1000D standard:
- **Format**: AMP-02-22-00-XX-XX-XXX-A.XML
