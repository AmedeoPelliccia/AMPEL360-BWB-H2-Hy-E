...
- Interfaces with **CAOS / AirCCC** for advisory intelligence and monitoring  

It translates the governance and lifecycle framework defined in
`02-00-00_GENERAL/` into **concrete operational views**.
...
- Detailed performance data, envelopes, limitations  
  → `02-20_Subsystems/` and their system chapters  
- Detailed engineering analyses (FEA, CFD, etc.)  
  → `02-00-06_ENGINEERING/` and technology ATA chapters  
...
- Scope and intent  
- Links to relevant `02-20_` subsystems and other ATA chapters  
...
- **CAOS layer (`/CAOS`)**  
  Consumes the operational model defined here as the **semantic backbone** for
...
- Do **not** recreate the 14 lifecycle folders (01_OVERVIEW … 14_META_GOVERNANCE)
  inside this bucket; those belong to `02-00-00_GENERAL/`.
