...
This folder is part of the **53-00_GENERAL** layer, which provides governance and lifecycle management for ATA Chapter 53. It contains comprehensive requirements organized into seven categories, with full traceability to regulatory standards ([CS-25](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), FAR 25) and supporting verification activities.
...
- **Key Standards**: [CS-25.301](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.303](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.305](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.603](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.609](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes)
...
- **Key Standards**: [CS-25.365](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.571](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.841](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes)
...
- **Key Standards**: [CS-25.571](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.1529](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [AC 20-107B](https://www.faa.gov/regulations_policies/advisory_circulars)
...
- **Key Standards**: [CS-25.561](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.562](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.803](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes)
...
- **Key Standards**: [CS-25.853](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.855](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.856](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes)
...
- **Key Standards**: [CS-25.783](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.773](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.721](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes)
...
- **Key Standards**: [CS-25.1309](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), [CS-25.1529](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes)
...
### standards/
- **`CS_25_Compliance_Map.csv`** — Mapping of ATA 53 requirements to [CS-25](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes) paragraphs with compliance methods and evidence
...
- **Parent Requirements**: Regulatory references ([CS-25](https://www.easa.europa.eu/en/document-library/certification-specifications/cs-25-large-aeroplanes), FAR 25, Advisory Circulars)
