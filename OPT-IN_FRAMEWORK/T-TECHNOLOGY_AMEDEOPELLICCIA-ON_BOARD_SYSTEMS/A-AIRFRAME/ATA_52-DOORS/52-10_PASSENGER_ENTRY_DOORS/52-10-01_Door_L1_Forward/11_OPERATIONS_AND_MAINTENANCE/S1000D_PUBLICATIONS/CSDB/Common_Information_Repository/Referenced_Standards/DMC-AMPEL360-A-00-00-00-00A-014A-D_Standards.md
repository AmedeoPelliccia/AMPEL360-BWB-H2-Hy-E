# Referenced Standards - Door L1 Forward
## DMC-AMPEL360-A-00-00-00-00A-014A-D
...
- **EASA SC-AMPEL360-001** - BWB Door Integration
...
- **ASTM D2000** - Rubber Products in Automotive Applications (Seals)
- **ISO 9227** - Corrosion tests in artificial atmospheres
- **ASTM B600** - Thermocouple Materials
...
- **NADCAP** - Special Process Standards
...
- **ASTM D3039** - Tensile Properties of Composites
- **DO-160** - Environmental Testing (Aircraft Equipment)
- **MIL-STD-810** - Environmental Engineering Considerations

### 4.2 Functional Testing
- **SAE AS5272** - Latching and Locking Systems
- **ISO 6867** - Leak Testing - Air Leakage
...
## 8. CAOS AND DIGITAL STANDARDS

### 8.1 Data Exchange Standards
- **IEEE 802.3** - Ethernet
...
### 8.3 Artificial Intelligence Standards
...
### 9.2 Fire Safety
- **FAA 14 CFR Part 25.853** - Fire Protection of Interior Materials
- **ISO 2685** - Fire Test Procedures for Aircraft Seat Materials
...
## 11. CYBER SECURITY STANDARDS

### 11.1 Aircraft Cybersecurity
- **DO-326A** - Airworthiness Security Process Specification
...
- **ISO/IEC 27001** - Information Security Management
- **NIST Cybersecurity Framework** - Cyber Security Best Practices

---

## 12. HUMAN FACTORS STANDARDS

### 12.1 Ergonomics
- **SAE AS8049** - Human Engineering Design Criteria
- **MIL-STD-1472** - Human Engineering
- **ISO 9241** - Ergonomics of Human-System Interaction

### 12.2 Maintenance Human Factors
...
## 13. APPLICABLE AMENDMENTS

All standards are applicable in their latest revision unless otherwise specified. When conflicts exist between standards, the order of precedence is:

1. Regulatory requirements (FAA/EASA)
2. Type certificate requirements
3. Industry standards (SAE, ASTM)
...
**Prepared by:** AMPEL360 Engineering Standards  
...
*This document is part of the S1000D-compliant Common Information Repository for AMPEL360 aircraft.*
