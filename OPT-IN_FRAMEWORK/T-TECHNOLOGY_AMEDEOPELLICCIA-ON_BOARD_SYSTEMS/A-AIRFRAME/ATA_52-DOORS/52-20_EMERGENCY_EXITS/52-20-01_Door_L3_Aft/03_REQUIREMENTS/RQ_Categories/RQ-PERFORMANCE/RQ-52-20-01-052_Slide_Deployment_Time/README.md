...
**RQ-52-20-01-052:** Slide_Deployment_Time

### Description

The Door L3 Aft Emergency Exit shall meet the following performance requirement: **6 seconds (±2 seconds tolerance)**.
...
**Performance Target:** 6 seconds (±2 seconds tolerance)
