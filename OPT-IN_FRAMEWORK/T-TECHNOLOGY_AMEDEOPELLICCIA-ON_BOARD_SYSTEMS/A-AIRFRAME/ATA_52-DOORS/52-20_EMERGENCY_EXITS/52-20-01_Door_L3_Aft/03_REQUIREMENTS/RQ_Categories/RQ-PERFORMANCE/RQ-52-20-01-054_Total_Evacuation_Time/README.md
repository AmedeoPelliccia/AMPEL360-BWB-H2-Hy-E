...
**RQ-52-20-01-054:** Total_Evacuation_Time

### Description

The Door L3 Aft Emergency Exit shall meet the following performance requirement: **75 seconds (maximum 90 seconds)**.
...
**Performance Target:** 75 seconds (maximum 90 seconds)
