# RQ-032: Visual Status Indicators
...
The Door L3 Aft Emergency Exit shall provide the following functional capability: **Visual Status Indicators**.
...
**Function:** Visual Status Indicators
