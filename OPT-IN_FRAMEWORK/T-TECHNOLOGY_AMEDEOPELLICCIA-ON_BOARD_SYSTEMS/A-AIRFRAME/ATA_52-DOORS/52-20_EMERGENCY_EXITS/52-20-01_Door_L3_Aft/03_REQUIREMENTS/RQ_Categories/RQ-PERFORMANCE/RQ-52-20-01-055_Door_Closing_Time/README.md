...
**RQ-52-20-01-055:** Door_Closing_Time

### Description

The Door L3 Aft Emergency Exit shall meet the following performance requirement: **10 seconds (±2 seconds tolerance)**.
...
**Performance Target:** 10 seconds (±2 seconds tolerance)
