# RQ-022: Manual Opening Force max 30 lbf
...
The Door L3 Aft Emergency Exit shall provide the following functional capability: **Manual Opening Force max 30 lbf**.
...
**Function:** Manual Opening Force max 30 lbf
