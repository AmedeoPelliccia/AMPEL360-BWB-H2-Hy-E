# RQ-52-20-01-008: Door Frame Strength
...
Door frame shall transfer all loads to fuselage structure without yielding at limit load
...
Load path integrity to primary structure
