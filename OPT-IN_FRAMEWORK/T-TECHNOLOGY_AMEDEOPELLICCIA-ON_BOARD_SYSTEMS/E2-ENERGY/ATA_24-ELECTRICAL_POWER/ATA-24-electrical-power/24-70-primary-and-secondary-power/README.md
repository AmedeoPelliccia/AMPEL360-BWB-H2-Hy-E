...
Defines the strategy for maintaining power to essential systems during loss of primary power sources, including emergency power sources and essential bus management.

## Subjects

- **24-70-00**: Primary/secondary power overview — Introduction to emergency power systems
- **24-70-01**: Emergency/standby sources — Battery-only, auxiliary generators, and backup systems
- **24-70-02**: Essential power architecture — Essential bus configuration and feeding rules
- **24-70-03**: Automatic reconfiguration logic — Loss-of-source detection and automatic switching
- **24-70-04**: Endurance/energy budgeting — Time-on-essential loads and energy management
- **24-70-07**: Monitoring & BITE — Emergency power system monitoring
- **24-70-10**: Verification — Endurance tests, failure scenarios, and dispatch rules
...
- **Section**: 24-70 — Primary & Secondary Power
