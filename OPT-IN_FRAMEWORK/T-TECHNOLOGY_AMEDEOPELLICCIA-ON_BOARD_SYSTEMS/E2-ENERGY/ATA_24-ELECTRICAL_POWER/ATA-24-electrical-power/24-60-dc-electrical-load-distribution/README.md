...
Critical for hydrogen-electric aircraft with significant DC loads and high-voltage DC distribution. Includes advanced protection strategies for HVDC systems.

## Subjects

- **24-60-00**: DC distribution overview — Introduction to DC load distribution
- **24-60-01**: DC bus topology — HVDC, LVDC, essential, and emergency bus architecture
- **24-60-02**: Switching devices & control — Contactors, SSPCs, and control logic
- **24-60-03**: Load management & shedding — Priority levels and brownout strategies
- **24-60-04**: Protections & selectivity — Arc fault, overcurrent, and IMD integration
- **24-60-05**: Grounding/return paths and bonding — Grounding strategy and bonding requirements
- **24-60-07**: Monitoring, metering & BITE — Real-time DC system monitoring
- **24-60-10**: Verification — Fault clearing, IMD tests, and brownout recovery
