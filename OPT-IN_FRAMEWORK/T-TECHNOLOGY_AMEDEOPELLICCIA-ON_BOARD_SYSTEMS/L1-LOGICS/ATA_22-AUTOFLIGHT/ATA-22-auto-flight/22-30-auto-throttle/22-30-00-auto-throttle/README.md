# ATA 22-30-00 — Auto Throttle

## Overview

This is the general subject for ATA 22-30, containing common information applicable across all Auto Throttle systems.
...
- Master source files for auto throttle systems
- Thrust computation algorithms
- Mode logic and state machines
- Fuel cell dynamics integration
- Battery buffering strategy
...
### AMM (Aircraft Maintenance Manual)
Documentation for auto throttle maintenance, calibration, and troubleshooting.

### IPC (Illustrated Parts Catalog)
Illustrated parts breakdown for auto throttle components and interfaces.
...
PM-22-30-00-001,DM-22-30-00-001,1,ALL
PM-22-30-00-001,DM-22-30-00-002,2,ALL
```
