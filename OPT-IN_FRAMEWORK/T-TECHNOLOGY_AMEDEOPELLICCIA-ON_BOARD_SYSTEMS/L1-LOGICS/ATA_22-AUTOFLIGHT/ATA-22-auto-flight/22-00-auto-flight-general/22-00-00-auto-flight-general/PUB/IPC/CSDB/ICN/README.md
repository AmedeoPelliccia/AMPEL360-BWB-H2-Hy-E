...
**System Diagram (SVG)**:
```
ICN-AMPEL360-22-00-0001-A_001.SVG
```
*Autoflight system block diagram*

**Component Photo (PNG)**:
```
ICN-AMPEL360-22-10-0025-A_001.PNG
```
*Autopilot control panel photograph*

**Wiring Diagram (SVG)**:
```
ICN-AMPEL360-22-20-0100-A_001.SVG
```
*Flight director wiring schematic*

**Multi-Sheet Drawing**:
```
ICN-AMPEL360-22-30-0200-A_001.SVG  (Sheet 1)
ICN-AMPEL360-22-30-0200-A_002.SVG  (Sheet 2)
ICN-AMPEL360-22-30-0200-A_003.SVG  (Sheet 3)
```
*Yaw damper installation (3 sheets)*
...
**Parts Identification**:
- Parts breakdown step illustrations
...
- Parts breakdown decision trees
- Test sequence flows
...
```
ICN-AMPEL360-22-00-0001-A_001.SVG       (Base graphic)
ICN-AMPEL360-22-00-0001-A_001_HS.XML    (Hotspot definitions)
```
...
```
ICN-AMPEL360-22-00-0001-A_001.SVG           (Base graphic)
ICN-AMPEL360-22-00-0001-A_001_EN-US.XML     (English callouts)
ICN-AMPEL360-22-00-0001-A_001_FR-FR.XML     (French callouts)
```
...
```xml
<figure id="fig-0001">
  <title>Autoflight System Block Diagram</title>
  <graphic infoEntityIdent="ICN-AMPEL360-22-00-0001-A"/>
</figure>
```
...
- `../PM/` - Publication Modules that include illustrated DMs
