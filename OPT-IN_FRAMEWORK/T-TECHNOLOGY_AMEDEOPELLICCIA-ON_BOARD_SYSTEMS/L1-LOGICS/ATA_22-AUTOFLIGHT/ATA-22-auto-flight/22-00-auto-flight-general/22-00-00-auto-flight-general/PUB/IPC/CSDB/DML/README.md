...
```
DML-AMPEL360-22-00-SYSDESC_EN-US_001-00.XML
```
*List of all descriptive data modules for autoflight system*

**Maintenance Procedures DML**:
```
DML-AMPEL360-22-00-MAINTPROC_EN-US_001-00.XML
```
*List of all parts catalog procedure data modules*

**Troubleshooting DML**:
```
DML-AMPEL360-22-00-FLTISOL_EN-US_001-00.XML
```
*List of all fault isolation data modules*

**Translation Set DML**:
```
DML-AMPEL360-22-00-TRANSFR_FR-FR_001-00.XML
```
...
DML-AMPEL360-22-00-REL001_EN-US_001-00.XML
```

**Update Release DML**:
```xml
<!-- Lists only changed DMs for incremental update -->
DML-AMPEL360-22-00-UPD002_EN-US_001-00.XML
```
...
DML-AMPEL360-22-00-REVIEW_EN-US_001-00.XML
```

**Approval DML**:
```xml
<!-- DMs awaiting final approval -->
DML-AMPEL360-22-00-APPROVAL_EN-US_001-00.XML
```
...
DML-AMPEL360-22-00-COMFR_FR-FR_001-00.XML
```
