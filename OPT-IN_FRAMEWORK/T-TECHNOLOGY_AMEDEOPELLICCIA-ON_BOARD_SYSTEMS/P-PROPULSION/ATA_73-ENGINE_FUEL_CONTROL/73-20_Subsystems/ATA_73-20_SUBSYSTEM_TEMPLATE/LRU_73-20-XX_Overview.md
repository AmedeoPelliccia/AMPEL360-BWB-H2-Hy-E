# LRU_73-20-XX — [ENGINE_FUEL_CONTROL] Subsystem Overview

## Document Information

- **Document ID**: LRU_73-20-XX_Overview
- **Title**: [ENGINE_FUEL_CONTROL] Line Replaceable Unit Overview
- **ATA Chapter**: 73 – Engine Fuel Control
- **Subsystem Code**: 73-20-XX
- **Version**: 1.0
- **Status**: DRAFT
- **Date**: 2025-12-01
...
This document provides a comprehensive overview of the **[Subsystem Name]** Line Replaceable Unit (LRU) as part of ATA Chapter 73 – Engine Fuel Control. It defines the functional scope, component breakdown, interfaces, and maintenance philosophy for the LRU.
...
| Attribute | Value |
|-----------|-------|
| **LRU Part Number** | PN-73-20-XX-001 |
...
- [LRI_01_ComponentA Design](./LRI/LRI_01_ComponentA/73-20-XX_Design.md)
- [LRI_02_ComponentB Design](./LRI/LRI_02_ComponentB/73-20-XX_Design.md)
- [LRI_03_ComponentC Design](./LRI/LRI_03_ComponentC/73-20-XX_Design.md)
...
|--------------|------------------|-----|------|-------------|
| IF-73-20-001 | [System] | [XX] | Electrical | [Description] |
| IF-73-20-002 | Electrical Power | 24 | Electrical | Power supply |
| IF-73-20-003 | [System] | [XX] | Data | Status/health data |
...
**Location**: `../../../73-90_Tables_Schemas_Diagrams/ATA_73-90_CIR/`

| CIR ID | Type | Description | File |
|--------|------|-------------|------|
| 73-90-20_73-02-FIG_001 | Figure (SVG) | ComponentA Assembly | [Link](../../../73-90_Tables_Schemas_Diagrams/ATA_73-90_CIR/73-90-20_73-02-FIG_001-ComponentA.svg) |
| 73-90-20_73-02-TABLE_001 | Table (CSV) | ComponentA Specifications | [Link](../../../73-90_Tables_Schemas_Diagrams/ATA_73-90_CIR/73-90-20_73-02-TABLE_001-ComponentA.csv) |
