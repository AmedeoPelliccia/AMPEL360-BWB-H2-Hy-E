...
This directory contains the Single Source of Truth for Emergency Logic, Inhibits and Load Shedding (29-20-60-emergency-logic-inhibits-and-load-shedding).
...
- **REQUIREMENTS/**: Requirements specifications and traceability matrices
  - `29-20-60_requirements.csv`
  - `29-20-60_traceability.csv`
