...
This directory contains the Single Source of Truth for Thermal Management, Cooling and Fluid Conditioning (29-10-70-thermal-management-cooling-and-fluid-conditioning).
...
- **REQUIREMENTS/**: Requirements specifications and traceability matrices
  - `29-10-70_requirements.csv`
  - `29-10-70_traceability.csv`
