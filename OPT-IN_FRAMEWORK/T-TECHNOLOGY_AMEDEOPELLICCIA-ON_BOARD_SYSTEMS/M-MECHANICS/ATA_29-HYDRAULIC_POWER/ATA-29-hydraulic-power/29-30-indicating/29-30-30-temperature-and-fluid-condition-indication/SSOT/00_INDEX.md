...
This directory contains the Single Source of Truth for Temperature and Fluid Condition Indication (29-30-30-temperature-and-fluid-condition-indication).
...
- **REQUIREMENTS/**: Requirements specifications and traceability matrices
  - `29-30-30_requirements.csv`
  - `29-30-30_traceability.csv`
