...
This directory contains publication-specific views for Asymmetry Protection And Load Limiting (27-80-30-asymmetry-protection-and-load-limiting).
...
```
DMC-AMPEL360AT-27-80-30-040A-A-A_001_00_EN-US_001-00.XML
```
