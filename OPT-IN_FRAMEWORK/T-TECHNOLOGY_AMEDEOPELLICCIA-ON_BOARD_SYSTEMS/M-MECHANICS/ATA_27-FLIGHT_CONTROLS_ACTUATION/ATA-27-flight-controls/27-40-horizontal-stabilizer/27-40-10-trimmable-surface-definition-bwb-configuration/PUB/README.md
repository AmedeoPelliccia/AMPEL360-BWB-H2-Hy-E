...
This directory contains publication-specific views for Trimmable Surface Definition BWB Configuration (27-40-10-trimmable-surface-definition-bwb-configuration).
...
```
DMC-AMPEL360AT-27-40-10-040A-A-A_001_00_EN-US_001-00.XML
```
