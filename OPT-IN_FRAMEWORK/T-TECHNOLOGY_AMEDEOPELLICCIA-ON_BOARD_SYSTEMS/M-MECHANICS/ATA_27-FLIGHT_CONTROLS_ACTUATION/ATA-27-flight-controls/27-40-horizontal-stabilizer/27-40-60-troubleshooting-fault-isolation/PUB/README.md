...
This directory contains publication-specific views for Troubleshooting Fault Isolation (27-40-60-troubleshooting-fault-isolation).
...
```
DMC-AMPEL360AT-27-40-60-040A-A-A_001_00_EN-US_001-00.XML
```
