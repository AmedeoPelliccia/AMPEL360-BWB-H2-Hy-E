...
This directory contains publication-specific views for Control Modes Limits And Protections (27-40-30-control-modes-limits-and-protections).
...
```
DMC-AMPEL360AT-27-40-30-040A-A-A_001_00_EN-US_001-00.XML
```
