...
This directory contains publication-specific views for Feel Centering And Mechanical Backup If Any (27-30-40-feel-centering-and-mechanical-backup-if-any).
...
```
DMC-AMPEL360AT-27-30-40-040A-A-A_001_00_EN-US_001-00.XML
```
