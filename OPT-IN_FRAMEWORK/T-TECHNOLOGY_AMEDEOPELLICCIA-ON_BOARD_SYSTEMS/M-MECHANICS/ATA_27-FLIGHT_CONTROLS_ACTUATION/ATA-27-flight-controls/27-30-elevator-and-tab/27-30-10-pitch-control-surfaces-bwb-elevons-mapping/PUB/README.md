...
This directory contains publication-specific views for Pitch Control Surfaces BWB Elevons Mapping (27-30-10-pitch-control-surfaces-bwb-elevons-mapping).
...
```
DMC-AMPEL360AT-27-30-10-040A-A-A_001_00_EN-US_001-00.XML
```
