...
This directory contains publication-specific views for Control Modes Limits And Reversion (27-10-30-control-modes-limits-and-reversion).
...
```
DMC-AMPEL360AT-27-10-30-040A-A-A_001_00_EN-US_001-00.XML
```
