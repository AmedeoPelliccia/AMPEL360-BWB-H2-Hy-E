...
This directory contains publication-specific views for Roll Control Surfaces Definition BWB Elevons (27-10-10-roll-control-surfaces-definition-bwb-elevons).
...
```
DMC-AMPEL360AT-27-10-10-040A-A-A_001_00_EN-US_001-00.XML
```
