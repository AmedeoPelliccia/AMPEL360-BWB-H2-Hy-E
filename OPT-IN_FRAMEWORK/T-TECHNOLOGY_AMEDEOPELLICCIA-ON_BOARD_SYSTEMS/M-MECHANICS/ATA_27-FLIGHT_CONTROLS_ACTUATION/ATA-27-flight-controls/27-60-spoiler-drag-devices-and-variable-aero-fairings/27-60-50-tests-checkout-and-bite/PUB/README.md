...
This directory contains publication-specific views for Tests Checkout And BITE (27-60-50-tests-checkout-and-bite).
...
```
DMC-AMPEL360AT-27-60-50-040A-A-A_001_00_EN-US_001-00.XML
```
