...
This directory contains publication-specific views for Yaw Control Surfaces Drag Rudder BWB Mapping (27-20-10-yaw-control-surfaces-drag-rudder-bwb-mapping).
...
```
DMC-AMPEL360AT-27-20-10-040A-A-A_001_00_EN-US_001-00.XML
```
