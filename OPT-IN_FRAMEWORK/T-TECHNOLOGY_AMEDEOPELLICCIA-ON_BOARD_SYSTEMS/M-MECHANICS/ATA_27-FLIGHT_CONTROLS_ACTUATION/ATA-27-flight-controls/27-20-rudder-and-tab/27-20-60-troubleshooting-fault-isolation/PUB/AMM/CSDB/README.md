...
This is the S1000D Common Source Database for Troubleshooting Fault Isolation (27-20-60-troubleshooting-fault-isolation).
...
Format: `DMC-AMPEL360AT-27-20-60-<InfoCode>-<Variant>-<ItemLoc>_<Learn>_<LearnEvent>_<Lang>-<Country>_<Issue>-<InWork>.XML`

### Illustration Codes

Format: `ICN-AMPEL360AT-27-20-60-<Seq>-<Variant>_<Issue>.<ext>`
