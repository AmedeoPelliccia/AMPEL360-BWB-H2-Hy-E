...
This is the S1000D Common Source Database for Control Laws Command Path And Latency Budget (27-00-40-control-laws-command-path-and-latency-budget).
...
Format: `DMC-AMPEL360AT-27-00-40-<InfoCode>-<Variant>-<ItemLoc>_<Learn>_<LearnEvent>_<Lang>-<Country>_<Issue>-<InWork>.XML`

### Illustration Codes

Format: `ICN-AMPEL360AT-27-00-40-<Seq>-<Variant>_<Issue>.<ext>`
