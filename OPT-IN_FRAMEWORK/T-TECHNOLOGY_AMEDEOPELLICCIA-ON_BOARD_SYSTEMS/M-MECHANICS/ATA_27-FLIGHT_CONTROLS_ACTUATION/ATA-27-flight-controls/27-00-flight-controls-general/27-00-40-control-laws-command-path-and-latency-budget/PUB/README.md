...
This directory contains publication-specific views for Control Laws Command Path And Latency Budget (27-00-40-control-laws-command-path-and-latency-budget).
...
```
DMC-AMPEL360AT-27-00-40-040A-A-A_001_00_EN-US_001-00.XML
```
