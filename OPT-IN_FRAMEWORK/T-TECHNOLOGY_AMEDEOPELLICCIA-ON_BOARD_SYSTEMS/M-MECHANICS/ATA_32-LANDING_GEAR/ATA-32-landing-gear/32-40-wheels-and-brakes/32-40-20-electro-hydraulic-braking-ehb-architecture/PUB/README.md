...
This directory contains publication-specific views for Electro-Hydraulic Braking (EHB) Architecture (32-40-20).
...
```
DMC-AMPEL360AT-32-40-20-040A-A-A_001_00_EN-US_001-00.XML
```
