...
This directory contains publication-specific views for MLG Locks (Uplock/Downlock) and Manual Release (32-10-40).
...
```
DMC-AMPEL360AT-32-10-40-040A-A-A_001_00_EN-US_001-00.XML
```
