...
This directory contains publication-specific views for MLG Local Actuation (PCU/EHA) and Sensors (32-10-20).
...
```
DMC-AMPEL360AT-32-10-20-040A-A-A_001_00_EN-US_001-00.XML
```
