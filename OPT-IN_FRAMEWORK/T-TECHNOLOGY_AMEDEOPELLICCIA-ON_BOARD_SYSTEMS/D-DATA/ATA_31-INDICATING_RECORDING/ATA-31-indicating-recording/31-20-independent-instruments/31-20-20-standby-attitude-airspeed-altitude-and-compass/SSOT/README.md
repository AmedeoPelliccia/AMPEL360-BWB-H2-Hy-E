...
This directory contains the **Single Source of Truth** (SSOT) for **31-20-20-standby-attitude-airspeed-altitude-and-compass**. All content originates here before being transformed into publication-specific formats.
