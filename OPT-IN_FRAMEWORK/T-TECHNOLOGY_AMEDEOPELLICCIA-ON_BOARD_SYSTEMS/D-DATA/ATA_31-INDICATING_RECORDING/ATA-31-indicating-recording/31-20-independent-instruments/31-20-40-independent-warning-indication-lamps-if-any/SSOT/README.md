...
This directory contains the **Single Source of Truth** (SSOT) for **31-20-40-independent-warning-indication-lamps-if-any**. All content originates here before being transformed into publication-specific formats.
