...
This directory contains the **Single Source of Truth** (SSOT) for **31-20-10-standby-flight-display-and-power-source**. All content originates here before being transformed into publication-specific formats.
