...
This directory contains the **Single Source of Truth** (SSOT) for **31-20-30-clock-time-of-day-chronometer-and-time-sync**. All content originates here before being transformed into publication-specific formats.
