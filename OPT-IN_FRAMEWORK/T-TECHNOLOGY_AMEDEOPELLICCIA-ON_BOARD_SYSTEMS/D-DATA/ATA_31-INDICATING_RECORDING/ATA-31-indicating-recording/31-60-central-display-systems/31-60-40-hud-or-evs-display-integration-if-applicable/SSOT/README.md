...
This directory contains the **Single Source of Truth** (SSOT) for **31-60-40-hud-or-evs-display-integration-if-applicable**. All content originates here before being transformed into publication-specific formats.
