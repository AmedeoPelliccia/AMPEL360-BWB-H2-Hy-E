...
This directory contains the **Single Source of Truth** (SSOT) for **31-60-30-display-source-switching-reversion-and-standby**. All content originates here before being transformed into publication-specific formats.
