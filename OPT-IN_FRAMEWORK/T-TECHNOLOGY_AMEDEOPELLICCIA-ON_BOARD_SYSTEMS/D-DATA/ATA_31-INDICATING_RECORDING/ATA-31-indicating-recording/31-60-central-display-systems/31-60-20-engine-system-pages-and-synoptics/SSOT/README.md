...
This directory contains the **Single Source of Truth** (SSOT) for **31-60-20-engine-system-pages-and-synoptics**. All content originates here before being transformed into publication-specific formats.
