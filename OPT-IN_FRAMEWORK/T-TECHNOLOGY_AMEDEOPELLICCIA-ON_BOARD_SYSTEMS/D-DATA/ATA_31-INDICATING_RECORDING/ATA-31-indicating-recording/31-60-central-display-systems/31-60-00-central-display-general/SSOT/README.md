...
This directory contains the **Single Source of Truth** (SSOT) for **31-60-00-central-display-general**. All content originates here before being transformed into publication-specific formats.
