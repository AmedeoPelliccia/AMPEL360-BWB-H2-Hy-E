...
This directory contains the **Single Source of Truth** (SSOT) for **31-10-10-overhead-and-system-control-panels**. All content originates here before being transformed into publication-specific formats.
