...
This directory contains the **Single Source of Truth** (SSOT) for **31-10-00-panels-general**. All content originates here before being transformed into publication-specific formats.
