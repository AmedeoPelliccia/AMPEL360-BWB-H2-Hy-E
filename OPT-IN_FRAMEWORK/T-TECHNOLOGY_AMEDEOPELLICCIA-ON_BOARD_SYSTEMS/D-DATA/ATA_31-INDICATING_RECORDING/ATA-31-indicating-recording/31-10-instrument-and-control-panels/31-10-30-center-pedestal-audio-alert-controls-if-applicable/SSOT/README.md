...
This directory contains the **Single Source of Truth** (SSOT) for **31-10-30-center-pedestal-audio-alert-controls-if-applicable**. All content originates here before being transformed into publication-specific formats.
