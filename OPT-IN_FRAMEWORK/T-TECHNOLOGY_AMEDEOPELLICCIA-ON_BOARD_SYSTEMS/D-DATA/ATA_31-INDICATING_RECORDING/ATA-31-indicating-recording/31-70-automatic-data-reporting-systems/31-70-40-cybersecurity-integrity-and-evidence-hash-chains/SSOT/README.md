...
This directory contains the **Single Source of Truth** (SSOT) for **31-70-40-cybersecurity-integrity-and-evidence-hash-chains**. All content originates here before being transformed into publication-specific formats.
