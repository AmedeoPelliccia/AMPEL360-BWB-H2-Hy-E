...
This directory contains the **Single Source of Truth** (SSOT) for **31-70-10-acms-logging-event-triggers-and-report-sets**. All content originates here before being transformed into publication-specific formats.
