...
This directory contains the **Single Source of Truth** (SSOT) for **31-70-30-data-links-wifi-satcom-vhf-integration-boundaries**. All content originates here before being transformed into publication-specific formats.
