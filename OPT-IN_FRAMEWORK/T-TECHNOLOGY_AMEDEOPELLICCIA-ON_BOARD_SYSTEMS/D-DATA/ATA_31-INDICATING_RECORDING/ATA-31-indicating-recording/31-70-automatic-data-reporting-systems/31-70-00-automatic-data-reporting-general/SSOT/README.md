...
This directory contains the **Single Source of Truth** (SSOT) for **31-70-00-automatic-data-reporting-general**. All content originates here before being transformed into publication-specific formats.
