...
This directory contains the **Single Source of Truth** (SSOT) for **31-40-20-alert-logic-hosting-and-prioritization-engine**. All content originates here before being transformed into publication-specific formats.
