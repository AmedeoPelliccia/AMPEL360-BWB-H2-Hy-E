...
This directory contains the **Single Source of Truth** (SSOT) for **31-40-50-bite-diagnostics-and-maintenance-interfaces**. All content originates here before being transformed into publication-specific formats.
