...
This directory contains the **Single Source of Truth** (SSOT) for **31-40-30-display-management-and-rendering-control**. All content originates here before being transformed into publication-specific formats.
