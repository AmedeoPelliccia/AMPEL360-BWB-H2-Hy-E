...
This directory contains the **Single Source of Truth** (SSOT) for **31-40-40-partitioning-ima-hosting-and-resource-budgets**. All content originates here before being transformed into publication-specific formats.
