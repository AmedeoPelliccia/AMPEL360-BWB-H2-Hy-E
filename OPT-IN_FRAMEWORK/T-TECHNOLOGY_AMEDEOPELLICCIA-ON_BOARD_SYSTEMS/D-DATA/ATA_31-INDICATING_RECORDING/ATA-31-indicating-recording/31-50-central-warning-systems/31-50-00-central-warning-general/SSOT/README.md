...
This directory contains the **Single Source of Truth** (SSOT) for **31-50-00-central-warning-general**. All content originates here before being transformed into publication-specific formats.
