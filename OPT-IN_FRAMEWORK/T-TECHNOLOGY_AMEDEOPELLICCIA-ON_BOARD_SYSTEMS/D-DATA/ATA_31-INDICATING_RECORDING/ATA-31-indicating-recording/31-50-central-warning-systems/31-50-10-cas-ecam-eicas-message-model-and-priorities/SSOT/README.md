...
This directory contains the **Single Source of Truth** (SSOT) for **31-50-10-cas-ecam-eicas-message-model-and-priorities**. All content originates here before being transformed into publication-specific formats.
