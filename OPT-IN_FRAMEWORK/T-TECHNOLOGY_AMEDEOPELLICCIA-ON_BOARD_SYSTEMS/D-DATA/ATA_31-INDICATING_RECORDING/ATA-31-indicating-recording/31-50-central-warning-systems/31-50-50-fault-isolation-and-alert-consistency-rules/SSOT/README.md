...
This directory contains the **Single Source of Truth** (SSOT) for **31-50-50-fault-isolation-and-alert-consistency-rules**. All content originates here before being transformed into publication-specific formats.
