...
This directory contains the **Single Source of Truth** (SSOT) for **31-50-30-master-warning-caution-lights-and-reset-logic**. All content originates here before being transformed into publication-specific formats.
