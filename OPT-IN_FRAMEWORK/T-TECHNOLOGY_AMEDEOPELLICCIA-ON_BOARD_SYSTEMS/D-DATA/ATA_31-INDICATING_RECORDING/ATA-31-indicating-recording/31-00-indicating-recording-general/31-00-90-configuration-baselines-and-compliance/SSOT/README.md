...
This directory contains the **Single Source of Truth** (SSOT) for **31-00-90-configuration-baselines-and-compliance**. All content originates here before being transformed into publication-specific formats.
