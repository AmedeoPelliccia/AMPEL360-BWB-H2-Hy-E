...
This directory contains the **Single Source of Truth** (SSOT) for **31-00-30-time-sync-stamping-and-event-model**. All content originates here before being transformed into publication-specific formats.
