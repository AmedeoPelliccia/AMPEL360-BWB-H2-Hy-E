...
This directory contains the **Single Source of Truth** (SSOT) for **31-00-10-system-architecture-and-dataflow**. All content originates here before being transformed into publication-specific formats.
