...
### 30-00_GENERAL (Lifecycle Folders)

The GENERAL layer contains 14 mandatory lifecycle folders covering the complete development cycle:

1. **30-00-01_Overview**: System overview and global architecture
2. **30-00-02_Safety**: Safety framework and analysis
3. **30-00-03_Requirements**: Requirements and traceability
4. **30-00-04_Design**: Design specifications and patterns
5. **30-00-05_Interfaces**: Interface control documents
6. **30-00-06_Engineering**: Analysis, models, and simulation
7. **30-00-07_V_AND_V**: Verification and validation
8. **30-00-08_Prototyping**: Prototype development
9. **30-00-09_Production_Planning**: Manufacturing planning
10. **30-00-10_Certification**: Certification evidence
11. **30-00-11_EIS_Versions_Tags**: Configuration management
12. **30-00-12_Services**: Maintenance and service
13. **30-00-13_Subsystems_Components**: Component breakdown
14. **30-00-14_Ops_Std_Sustain**: Operational standards
...
- **30-70_Propulsion**: Propulsion interfaces (if applicable)
