...
- **OPT-IN Framework** (`21-00_GENERAL`, `21-10_Operations`, etc.): Project lifecycle and development structure
- **ATA SNS** (`ATA-21-air-conditioning/`): Publication and certification structure
