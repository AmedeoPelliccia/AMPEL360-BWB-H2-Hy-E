...
This section covers: General air conditioning system information, overview, and cross-section documentation

## Structure

This directory contains subject-level documentation following the ATA SNS format 21-00-yy:

```
21-00-air-conditioning-general/
├── 21-00-00-air-conditioning-general/     # General subject
└── 21-00-YY-<subject-name>/      # Additional subjects (as needed per SNS)
```
...
1. Create directory: `21-00-YY-<descriptive-name>/`
...
- ATA iSpec 2200 SNS Section 21-00
