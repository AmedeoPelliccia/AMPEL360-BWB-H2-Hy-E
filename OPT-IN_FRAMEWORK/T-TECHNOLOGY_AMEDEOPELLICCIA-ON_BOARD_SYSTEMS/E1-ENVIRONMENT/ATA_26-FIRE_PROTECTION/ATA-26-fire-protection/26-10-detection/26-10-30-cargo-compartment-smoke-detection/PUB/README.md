...
This directory contains publication-specific views for Cargo Compartment Smoke Detection (26-10-30-cargo-compartment-smoke-detection).
...
```
DMC-AMPEL360AT-26-10-30-040A-A-A_001_00_EN-US_001-00.XML
```
