...
This is the S1000D Common Source Database for Lavatory Smoke Detection (26-10-40-lavatory-smoke-detection).
...
Format: `DMC-AMPEL360AT-26-10-40-<InfoCode>-<Variant>-<ItemLoc>_<Learn>_<LearnEvent>_<Lang>-<Country>_<Issue>-<InWork>.XML`

### Illustration Codes

Format: `ICN-AMPEL360AT-26-10-40-<Seq>-<Variant>_<Issue>.<ext>`

## Document Control

- **Subject**: 26-10-40-lavatory-smoke-detection
- **Model**: AMPEL360AT
