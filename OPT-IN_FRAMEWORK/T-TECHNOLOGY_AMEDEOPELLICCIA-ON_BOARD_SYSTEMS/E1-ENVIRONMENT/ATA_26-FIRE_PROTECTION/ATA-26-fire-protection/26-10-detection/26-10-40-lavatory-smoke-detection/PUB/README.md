...
This directory contains publication-specific views for Lavatory Smoke Detection (26-10-40-lavatory-smoke-detection).
...
```
DMC-AMPEL360AT-26-10-40-040A-A-A_001_00_EN-US_001-00.XML
```
