...
This directory contains publication-specific views for Battery Compartment Thermal Runaway Detection (26-10-70-battery-compartment-thermal-runaway-detection).
...
```
DMC-AMPEL360AT-26-10-70-040A-A-A_001_00_EN-US_001-00.XML
```
