# LRU_26-20-XX — [FIRE_PROTECTION] Subsystem Overview

## Document Information

- **Document ID**: LRU_26-20-XX_Overview
- **Title**: [FIRE_PROTECTION] Line Replaceable Unit Overview
- **ATA Chapter**: 26 – Fire Protection
- **Subsystem Code**: 26-20-XX
- **Version**: 1.0
- **Status**: DRAFT
- **Date**: 2025-12-01
...
This document provides a comprehensive overview of the **[Subsystem Name]** Line Replaceable Unit (LRU) as part of ATA Chapter 26 – Fire Protection. It defines the functional scope, component breakdown, interfaces, and maintenance philosophy for the LRU.
...
| Attribute | Value |
|-----------|-------|
| **LRU Part Number** | PN-26-20-XX-001 |
...
- [LRI_01_ComponentA Design](./LRI/LRI_01_ComponentA/26-20-XX_Design.md)
- [LRI_02_ComponentB Design](./LRI/LRI_02_ComponentB/26-20-XX_Design.md)
- [LRI_03_ComponentC Design](./LRI/LRI_03_ComponentC/26-20-XX_Design.md)
...
|--------------|------------------|-----|------|-------------|
| IF-26-20-001 | [System] | [XX] | Electrical | [Description] |
| IF-26-20-002 | Electrical Power | 24 | Electrical | Power supply |
| IF-26-20-003 | [System] | [XX] | Data | Status/health data |
...
**Location**: `../../../26-90_Tables_Schemas_Diagrams/ATA_26-90_CIR/`

| CIR ID | Type | Description | File |
|--------|------|-------------|------|
| 26-90-20_26-02-FIG_001 | Figure (SVG) | ComponentA Assembly | [Link](../../../26-90_Tables_Schemas_Diagrams/ATA_26-90_CIR/26-90-20_26-02-FIG_001-ComponentA.svg) |
| 26-90-20_26-02-TABLE_001 | Table (CSV) | ComponentA Specifications | [Link](../../../26-90_Tables_Schemas_Diagrams/ATA_26-90_CIR/26-90-20_26-02-TABLE_001-ComponentA.csv) |
