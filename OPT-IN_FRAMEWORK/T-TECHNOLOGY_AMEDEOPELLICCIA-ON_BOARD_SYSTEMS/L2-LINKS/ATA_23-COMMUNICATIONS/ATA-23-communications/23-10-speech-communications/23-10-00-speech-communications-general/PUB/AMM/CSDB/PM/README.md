...
This directory contains **Publication Modules (PM)** for the Aircraft Maintenance Manual (AMM). Publication Modules define the hierarchical structure and organization of technical publications in S1000D.
...
- **Publication Code**: Unique code identifying the publication type
  ...
  - `00020` - Maintenance Procedures Manual
...
```
*Defines the complete ATA 23-10 AMM structure*

**System Description Section**:
```
PMC-AMPEL360-23-10-00010_001_00_001-00.XML
```
*Speech communications system descriptions and theory of operation*
...
```
PMC-AMPEL360-23-10-00030_001_00_001-00.XML
```
...
Example hierarchy:
```
PMC-AMPEL360-23-10-00001 (Complete AMM)
├── PMC-AMPEL360-23-10-00010 (Descriptions)
│   ├── DMC-...-040A-... (System overview)
│   └── DMC-...-040A-... (Component descriptions)
├── PMC-AMPEL360-23-10-00020 (Procedures)
│   ├── DMC-...-520A-... (Test procedures)
│   └── DMC-...-520B-... (Maintenance procedures)
└── PMC-AMPEL360-23-10-00030 (Troubleshooting)
