...
```
DMC-AMPEL360-23-10-00-040A-A-A_001_00_EN-US_001-00.XML
```
*Description: General speech communications system overview*

**Procedural Data Module** (Info Code 520A):
```
DMC-AMPEL360-23-10-00-520A-A-001_001_00_EN-US_001-00.XML
```
*Description: VHF radio system test procedure*

**Fault Isolation Data Module** (Info Code 730A):
```
DMC-AMPEL360-23-10-00-730A-A-001_001_00_EN-US_001-00.XML
```
*Description: Communications fault isolation*

**Removal/Installation Data Module** (Info Code 520B):
```
DMC-AMPEL360-23-10-00-520B-A-001_001_00_EN-US_001-00.XML
```
*Description: Audio panel removal and installation*
