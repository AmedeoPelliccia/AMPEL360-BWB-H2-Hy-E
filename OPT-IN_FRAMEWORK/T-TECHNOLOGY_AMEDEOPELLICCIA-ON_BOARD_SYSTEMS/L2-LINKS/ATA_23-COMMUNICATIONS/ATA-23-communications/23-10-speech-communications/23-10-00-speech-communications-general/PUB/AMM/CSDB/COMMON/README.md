...
This directory contains **Common Information Sets** (also called Common Information Repositories or CIR) for the Aircraft Maintenance Manual (AMM). These are reusable content fragments that can be referenced from multiple Data Modules.
...
```
*RF energy hazard procedure*

**Tool Description**:
```
COM-AMPEL360-TOOL-00250_EN-US_001-00.XML
```
*Communications test set usage instructions*
...
<caution>
  ...
  <cautionText>
    <para>
      Do not transmit without antenna connected. Transmitting without 
      a proper antenna can damage the radio transceiver.
    </para>
  </cautionText>
</caution>
```
...
<note>
  ...
  <noteText>
    <para>
      Record all radio frequency test results in aircraft maintenance log.
    </para>
  </noteText>
</note>
```
...
<commonInfo>
  ...
  <procedure>
    <title>RF Energy Hazard Precautions</title>
    <proceduralStep>
      <para>Ensure all transmitters are disabled...</para>
    </proceduralStep>
    <!-- Additional steps -->
  </procedure>
</commonInfo>
...
<commonInfo>
  ...
  <definitionList>
    <definitionListItem>
      <term>VHF</term>
      <definition>
        <para>Very High Frequency (30-300 MHz)</para>
      </definition>
    </definitionListItem>
  </definitionList>
</commonInfo>
...
<commonInfo>
  ...
  <toolDescription>
    <toolIdent>T-23-001-A</toolIdent>
    <toolName>Communications Test Set</toolName>
    <toolSpec>
      <para>Frequency range: 118-137 MHz, Power: 0-25W</para>
    </toolSpec>
  </toolDescription>
</commonInfo>
```
...
```xml
<proceduralStep>
  <para>Before starting work, apply RF safety procedure:</para>
  <commonInfoRef>
    <commonInfoRefIdent>
...
- RF energy hazard warnings
- Antenna radiation warnings
