...
This directory contains the publication-ready content for data transmission and automatic calling system technical documentation.
...
- **Section**: 23-20-00 (Data Transmission and Automatic Calling)
- **Status**: Active
