...
**Air distribution systems, ducts, valves, and flow control**
...
```
21-20-distribution/
└─ 21-20-00-21-20-distribution/   # General subject (default)
...
### 21-20-00 — General (Default)

The `21-20-00-21-20-distribution` subject contains general information, common procedures, and overview documentation for this section.

**Additional subjects can be added** as `21-20-YY-<subject-name>` when specific subsystems or components require dedicated documentation per ATA iSpec 2200 SNS.
...
```
DMC-AMPEL-21-20-<subject>-<unit>-<item>-<variant>-<info-code>-<lang>
```

Example:
```
DMC-AMPEL-21-20-00-00A-520A-A  # Procedural DM
DMC-AMPEL-21-20-00-01A-040A-A  # Descriptive DM
DMC-AMPEL-21-20-00-02A-730A-A  # Fault Isolation DM
```
...
*For additional subjects beyond 21-20-00, create `21-20-YY-<subject-name>` directories following the same structure.*
