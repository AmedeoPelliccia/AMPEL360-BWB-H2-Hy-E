...
This section covers: Temperature control systems, sensors, and temperature regulation

## Structure

This directory contains subject-level documentation following the ATA SNS format 21-60-yy:

```
21-60-temperature-control/
├── 21-60-00-temperature-control/     # General subject
└── 21-60-YY-<subject-name>/      # Additional subjects (as needed per SNS)
```
...
1. Create directory: `21-60-YY-<descriptive-name>/`
...
- ATA iSpec 2200 SNS Section 21-60
