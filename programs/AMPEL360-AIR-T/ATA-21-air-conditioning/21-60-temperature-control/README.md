...
**Temperature sensing, control logic, and zonal climate management**
...
└─ 21-60-00-21-60-temperature-control/   # General subject (default)
...
### 21-60-00 — General (Default)

The `21-60-00-21-60-temperature-control` subject contains general information, common procedures, and overview documentation for this section.

**Additional subjects can be added** as `21-60-YY-<subject-name>` when specific subsystems or components require dedicated documentation per ATA iSpec 2200 SNS.
...
```
DMC-AMPEL-21-60-<subject>-<unit>-<item>-<variant>-<info-code>-<lang>
```

Example:
```
DMC-AMPEL-21-60-00-00A-520A-A  # Procedural DM
DMC-AMPEL-21-60-00-01A-040A-A  # Descriptive DM
DMC-AMPEL-21-60-00-02A-730A-A  # Fault Isolation DM
```
...
*For additional subjects beyond 21-60-00, create `21-60-YY-<subject-name>` directories following the same structure.*
