...
**Humidity control, air filtration, and contaminant removal systems**
...
└─ 21-70-00-21-70-moisture-air-contaminant-control/   # General subject (default)
...
### 21-70-00 — General (Default)

The `21-70-00-21-70-moisture-air-contaminant-control` subject contains general information, common procedures, and overview documentation for this section.

**Additional subjects can be added** as `21-70-YY-<subject-name>` when specific subsystems or components require dedicated documentation per ATA iSpec 2200 SNS.
...
```
DMC-AMPEL-21-70-<subject>-<unit>-<item>-<variant>-<info-code>-<lang>
```

Example:
```
DMC-AMPEL-21-70-00-00A-520A-A  # Procedural DM
DMC-AMPEL-21-70-00-01A-040A-A  # Descriptive DM
DMC-AMPEL-21-70-00-02A-730A-A  # Fault Isolation DM
```
...
*For additional subjects beyond 21-70-00, create `21-70-YY-<subject-name>` directories following the same structure.*
