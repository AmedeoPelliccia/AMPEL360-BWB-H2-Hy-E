# 21-40-00-21-40-heating — Heating General

## Overview

This subject directory contains general documentation and data modules for **Heating** under ATA 21-40.
...
```
DMC-AMPEL-21-40-00-<unit>-<item><variant>-<info-code><info-variant>-<lang>
```

Examples:
- `DMC-AMPEL-21-40-00-00A-520A-A` — Maintenance procedure
- `DMC-AMPEL-21-40-00-01A-040A-A` — System description
- `DMC-AMPEL-21-40-00-02A-730A-A` — Fault isolation
...
DMC-AMPEL-21-40-00-00A-940A-A,PMC-AMPEL-Q100-21-40-00-00A-00A,010
DMC-AMPEL-21-40-00-01A-520A-A,PMC-AMPEL-Q100-21-40-00-00A-00A,020
```
...
```yaml
# S1000D CSDB Profile
publication_id: "AMM-AMPEL-Q100-21-40-00"
issue_number: "001"
in_work: "01"
...
- Parent Section: [21-40-heating](../README.md)
- ATA 21 Overview: [../../README.md](../../README.md)

## Document Control

- **Subject**: 21-40-00-21-40-heating
- **Section**: ATA 21-40
- **Status**: ACTIVE
- **Version**: 1.0
- **Date**: 2026-01-08
...
*This subject uses the 21-xx-00 pattern as the "general" subject for section 21-40. Additional subjects can be added as 21-xx-YY when needed.*
