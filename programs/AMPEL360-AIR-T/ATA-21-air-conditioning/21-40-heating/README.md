...
This section covers: Heating systems including heat exchangers, electric heaters, and heating controls

## Structure

This directory contains subject-level documentation following the ATA SNS format 21-40-yy:

```
21-40-heating/
├── 21-40-00-heating/     # General subject
└── 21-40-YY-<subject-name>/      # Additional subjects (as needed per SNS)
```
...
1. Create directory: `21-40-YY-<descriptive-name>/`
...
- ATA iSpec 2200 SNS Section 21-40
